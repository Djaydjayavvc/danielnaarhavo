...
const tabBar = `
  ...
  .tab-btn.switch-btn { margin-left: auto; color: #64748b; }
  .tab-btn.switch-btn:hover { color: #f87171; }
`;

export function DanielTabs({ isHost, onSwitchProfile }: { isHost: boolean; onSwitchProfile?: () => void }) {
  ...
  return (
    <>
      ...
      <div className="tab-bar">
        ...
        {onSwitchProfile && (
          <button className="tab-btn switch-btn" onClick={onSwitchProfile}>
            ↺ Wissel
          </button>
        )}
      </div>
